/** @file Plots data from files generated by `analyze.py`. */
...
/** @returns {string} What file should be used, according to the current settings. */
 ...
 *  @returns {boolean} Is this university the result of a user search */
 ...
 *  @param {number[]} successCounter - The number of successes at seed differential [index]
 *  @param {number[]} totalCounter - The number of attempts at seed differential [index]
 *  @returns {number} */
 ...
 *  @param {{center: number, halfWidth: number}} confidenceInterval - for a binomial random variable */
 ...
 *  If the intersection would be outside the x-intervals, then clip it to occur at the boundary.
 *  If the slopes are parallel, the intersection is the midpoint of the two points.
 *  @param {number[]} lastPoint
 *  @param {number} lastSlope
 *  @param {number[]} nextPoint
 *  @param {number} nextSlope
 *  @returns {number[]} */
 ...
 *  @param {number} total
 *  @returns {{center: number, halfWidth: number}} for a binomial random variable */
...
/** @param {number} number
 *  @returns {string} The input, but dropping excess numbering point digits at the end */
 ...
 *  @param {number} max
 *  @param {boolean} isLog
 *  @returns {number} The fraction of the way data is along the interval [min, max] */
 ...
 *  @param {number} col
 *  @returns {number} The total of matrix along that particular column */
 ...
 *  @returns {HTMLElement} The element, so this method can be chained */
